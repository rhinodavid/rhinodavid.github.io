...
var RainbowCircle = function() {
  ...
  this.targetX = this.x; // target generally reset with mouse/touch
  this.targetY = this.y; // target generally reset with mouse/touch
  this.angle = 0; // initial value
  this.distance = 0; // inital value
  

  this.path = [];
  this.count = 40; // how many paths get drawn -- how long the trail is
  this.hue = 0; // initial value
  this.radius = 45;
...
RainbowCircle.prototype.debugAngles = function() {
  // invoke this at each frame to see the angle and theta of the circle
  // debugging theta
  ctx.beginPath();
